...
local function title()
	...
	centrizedText(y, 0x2D2D2D, "WanOs")
...
local installerMenu = menu:addContextMenuItem("WanOs", 0x2D2D2D)
...
addStage(function()
	...
	if not selectedFilesystemProxy.getLabel() then
		selectedFilesystemProxy.setLabel("WanOs HDD")
	end
	...
	component.invoke(EEPROMAddress, "setLabel", "WanOs EFI")
